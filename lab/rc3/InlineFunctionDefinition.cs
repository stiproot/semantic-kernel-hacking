...
public static class Example05_InlineFunctionDefinition
{
    public static async Task RunAsync()
    {
        ...
        string openAIModelId = Secrets.Gpt_4_32k;
        string openAIApiKey = Secrets.ApiKey;
        ...
        Microsoft.SemanticKernel.Kernel kernel = Factories.CreateKernel();

        // Microsoft.SemanticKernel.Kernel kernel = nMicrosoft.SemanticKernel.Kernel.CreateBuilder()
