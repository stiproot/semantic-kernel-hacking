...
internal static class NestedFnExample
{
    public static async Task RunAsync()
    {
        ...
        List<ChatHistory> fewShotExamples = [
            [
                new ChatRe(AuthorRole.User, "Can you send a very quick approval to the marketing team?"),
        ...
        var getIntent = kernel.CreateFunctionFromPrompt(
            ...
            promotTemplateFactory: new HandlebarsPromptTemplateFactory()
        );
